  ...
  <body>
    ...
    <script>
      ...
      if (localStorage.getItem('auth_token')) {
        ...
        switch (user.role) {
          case 'admin':
            window.location.href = '/SkillSense/admin/admin_index.php';
            break;
          case 'portfolio_owner':
            window.location.href = '/SkillSense/portfolio/dashboard.php';
            break;
          case 'employer':
            window.location.href = '/SkillSense/employer/dashboard.php';
            break;
          default:
            localStorage.clear();
